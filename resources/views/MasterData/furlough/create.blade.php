...
<div class="row justify-content-center">
    <div class="col-12 col-sm-12 col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('/cuti') }}" method="post">@csrf
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12">
                        ...
                        <div class="col-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <textarea autocomplete="off" class="form-control @error('information') is-invalid @enderror" name="information" id="information" rows="5">{{ old('information') }}</textarea>
                                    <div class="invalid-feedback">
                        ...
                        <div class="col-12">
                            <a href="{{ url('cuti') }}" title="Kembali" class="btn btn-primary">Kembali</a>
