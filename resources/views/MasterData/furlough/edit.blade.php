...
<div class="row justify-content-center">
    <div class="col-12 col-sm-12 col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('/cuti/' . $furlough->furlough_id) }}" method="post">@csrf @method('put')
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input readonly type="text" value="{{ $employee->name . '-' . $employee->nip }}" autocomplete="off" class="form-control @error('employee') is-invalid @enderror" name="employee" id="employee">
                        ...
                        <div class="col-12 col-sm-12 col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="{{ $furlough->in_number }}" autocomplete="off" class="form-control @error('in_number') is-invalid @enderror" name="in_number" id="in_number">
                                    <div class="invalid-feedback">
                        ...
                        <div class="col-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="{{ $furlough->decree()->first()->sk_number }}" autocomplete="off" class="form-control @error('sk_number') is-invalid @enderror" name="sk_number" id="sk_number">
                        ...
                        <div class="col-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    @if($furlough->status == 3 || $furlough->status == 4)
                                    <input type="date" value="{{ $furlough->decree()->first()->sk_date_start }}" autocomplete="off" class="form-control @error('sk_date_start') is-invalid @enderror" name="sk_date_start" id="sk_date_start">
                                    @else
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-ketentuan">
                            <div class="form-group form-ketentuan">
                                ...
                                <div class="input-group my-{{$loop->iteration}} ketentuan-{{$loop->iteration}}">
                                    ...
                                    <input type="text" value="{{$ket->provision_name}}" autocomplete="off" name="ketentuan[]" class="form-control">
                                </div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    @if($furlough->status == 3 || $furlough->status == 4)
                                    <textarea autocomplete="off" class="form-control @error('information') is-invalid @enderror" name="information" id="information" rows="5">{{ $furlough->decree()->first()->information }}</textarea>
                                    @else
                        ...
                        <div class="col-12">
                            <a href="{{ url('cuti/'.$furlough->furlough_id ) }}" title="Kembali" class="btn btn-primary">Kembali</a>
                            <button type="button" title="Tolak Cuti" class="btn btn-danger" onclick="(confirm('Data Cuti akan ditolak!\nLanjutkan?')) ? document.getElementById('declineForm').submit() : ''">Tolak</button>
                            <button type="submit" title="Setujui Cuti" class="btn btn-success">Setujui</button>
                        </div>
                    </div>
                </form><form action="{{ url('cuti/' . $furlough->furlough_id) }}" method="post" id="declineForm">@csrf @method('delete')</form>
            </div>
        </div>
    </div>
</div>
