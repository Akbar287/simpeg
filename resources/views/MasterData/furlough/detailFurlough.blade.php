            ...
            <div class="card-body">
                <form action="{{ url('/cuti/' . $furlough->furlough_id) }}" method="post">@csrf @method('put')
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input readonly type="text" value="{{ $employee->name }}" autocomplete="off" class="form-control @error('employee') is-invalid @enderror" name="employee" id="employee">
                        ...
                        <div class="col-12">
                            <a href="{{ url('/cuti') }}" type="button" title="Kembali" class="btn btn-primary">Kembali</a>
                            @if($furlough->status == 1)
                            <a href="{{ url('/cuti/' .$furlough->furlough_id . '/edit') }}" type="button" title="Ubah Data" class="btn btn-success">Edit</a>
