...
<div class="row justify-content-center">
    <div class="col-lg-12 col-md-12 col-12 col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('absensi/' . $attendance->attendance_id) }}" method="POST"">@csrf @method('put')
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <textarea autocomplete="off" class="form-control @error('information') is-invalid @enderror" name="information" id="information" cols="5">{{ $attendance->keterangan }}</textarea>
                                    <div class="invalid-feedback">
                        ...
                        <div class="col-12">
                            <a href="{{ url('/absensi' . $attendance->attendance_id) }}" title="Kembali" class="btn btn-primary">Kembali</a>
