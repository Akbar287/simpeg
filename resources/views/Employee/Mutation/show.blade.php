...
<div class="row justify-content-center">
    <div class="col-lg-12 col-md-12 col-12 col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('/pegawai/' . $employee->user_id . '/mutation') }}" method="post">@csrf
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    @if($mutation->status == 3 || $mutation->status == 4)
                                    <textarea readonly value="{{ $mutation->decree()->first()->information }}" autocomplete="off" class="form-control @error('information') is-invalid @enderror" name="information" id="information" rows="5"></textarea>
                                    @else
                        ...
                        <div class="col-12">
                            <a href="{{ url('/pegawai/' . $employee->user_id . '/mutation') }}" type="button" title="Kembali" class="btn btn-primary">Kembali</a>
                            @if($mutation->status == 1)
                            <a href="{{ url('/pegawai/' . $employee->user_id . '/mutation/' . $mutation->mutation_id . '/edit') }}" type="button" title="Ubah Data" class="btn btn-success">Edit</a>
