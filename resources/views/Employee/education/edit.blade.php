            ...
            <div class="card-body">
                <form action="{{ url('/pegawai/' . $employee->user_id . '/education') }}" method="post" enctype="multipart/form-data">@csrf
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="{{ $education->principal }}" autocomplete="off" class="form-control @error('principal') is-invalid @enderror" id="principal" name="principal" id="principal">
                        ...
                        <div class="col-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="{{ $education->school_name }}" autocomplete="off" class="form-control @error('school_name') is-invalid @enderror" name="school_name" id="Nama">
                                    <div class="invalid-feedback">
                        ...
                        <div class="col-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="{{ $education->location }}" autocomplete="off" class="form-control @error('location') is-invalid @enderror" name="location" id="location">
                                    <div class="invalid-feedback">
                        ...
                        <div class="col-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="{{ $education->major }}" autocomplete="off" class="form-control @error('major') is-invalid @enderror" name="major" id="major">
                                    <div class="invalid-feedback">
                        ...
                        <div class="col-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="{{ $education->diploma_number }}" autocomplete="off" class="form-control @error('diploma_number') is-invalid @enderror" name="diploma_number" id="diploma_number">
                                    <div class="invalid-feedback">
                        ...
                        <div class="col-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" value="{{ $education->diploma_date }}" autocomplete="off" class="form-control @error('diploma_date') is-invalid @enderror" name="diploma_date" id="diploma_date">
                                    <div class="invalid-feedback">
                        ...
                        <div class="col-12">
                            <a href="{{url('/pegawai/'.$employee->user_id . '/education/' . $education->education_id)}}" type="button" title="Kembali" class="btn btn-primary">Kembali</a>
