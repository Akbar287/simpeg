            ...
            <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input readonly type="date" value="{{ $attendance->date_work }}" autocomplete="off" class="form-control @error('date_work') is-invalid @enderror" name="date_work" id="date_work">
                        ...
                        <div class="col-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select disabled class="custom-select @error('jenis_kerja') is-invalid @enderror" name="jenis_kerja" id="jenis_kerja">
                        ...
                        <div class="col-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input readonly type="time" value="{{ $attendance->start_work ? $attendance->start_work : "07:00:00" }}" autocomplete="off" class="form-control @error('start_work') is-invalid @enderror" name="start_work" id="start_work">
                                    <div class="invalid-feedback">
                        ...
                        <div class="col-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input readonly type="time" value="{{ $attendance->finish_work ? $attendance->finish_work : "16:00:00" }}" autocomplete="off" class="form-control @error('finish_work') is-invalid @enderror" name="finish_work" id="finish_work">
                                    <div class="invalid-feedback">
                        ...
                        <div class="col-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select disabled class="custom-select @error('kehadiran') is-invalid @enderror" name="kehadiran" id="kehadiran">
                                        @foreach($kehadiran as $kehadira)
                                        <option {{ ($kehadira->kehadiran_id == $attendance->kehadiran()->first()->toArray()['kehadiran_id']) ? 'selected' : '' }} value="0">{{ $kehadira->name }}</option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">
                        ...
                        <div class="col-12">
                            ...
                            <a href="{{ url('pegawai/' . $employee->user_id . '/absensi/' . $attendance->attendance_id . '/edit') }}" title="Ubah Data" class="btn btn-success">Ubah Data</a>
                        ...
                        <form action="{{ url('pegawai/' . $employee->user_id . '/absensi/'. $attendance->attendance_id) }}" method="post" id="formDeleteAbsensi"> @csrf @method('delete')</form>
                        </div>
                    </div>
            </div>
        </div>
