...
<div class="row justify-content-center">
    <div class="col-lg-12 col-md-12 col-12 col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('/pegawai/' . $employee->user_id . '/cuti/' . $furlough->furlough_id) }}" method="post">@csrf @method('put')
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control @error('stamp') is-invalid @enderror" name="stamp" id="stamp">
                                        ...
                                        <option {{ ($furlough->stamp == $admin->user_id) ? 'selected' : '' }} value="{{ $admin->user_id }}">{{ $admin->name }} - {{ $admin->employment_name }}</option>
                                        @endforeach
                                        @else
                        ...
                        <div class="col-12">
                            <a href="{{ url('pegawai/' . $employee->user_id . '/cuti/' . $furlough->furlough_id) }}" title="Kembali" class="btn btn-primary">Kembali</a>
                ...
                </form><form action="{{ url('/pegawai/' . $employee->user_id . '/cuti/' . $furlough->furlough_id .'/decline') }}" method="post" id="declineForm">@csrf</form>
            </div>
        </div>
    </div>
</div>
