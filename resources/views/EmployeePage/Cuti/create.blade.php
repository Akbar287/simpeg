            ...
            <div class="card-body">
                <form action="{{ url('/izincuti') }}" method="post">@csrf
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="{{ old('in_number') }}" placeholder="Cth: Satu" autocomplete="off" class="form-control @error('in_number') is-invalid @enderror" name="in_number" id="in_number">
                                    <div class="invalid-feedback">
                        ...
                        <div class="col-12">
                            <a href="{{ url('izincuti') }}" title="Kembali" class="btn btn-primary">Kembali</a>
                            <button type="submit" title="Ajukan" class="btn btn-success">Ajukan</button>
                        </div>
                    </div>
                </form>
            </div>
